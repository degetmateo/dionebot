...
const InteraccionComandoUnsetup_1 = __importDefault(require("../../../comandos/modulos/InteraccionComandoUnsetup"));
        ...
        for (const usuario of usuarios) {
            ...
            try {
                ...
                if (message.includes('private user')) {
                    ...
                    await InteraccionComandoUnsetup_1.default.UnsetupUsuario(serverID, userID);
                }
            }
        }
    }
