...
class AnilistAPI {
    static async buscarAnimePorID(id) {
        return await BuscadorMedia_1.default.BuscarMediaPorID(id, 'ANIME');
    }
    ...
    static async buscarEstadoMediaUsuarios(usuarios, mediaID) {
        return await BuscadorEstadoMediaUsuarios_1.default.BuscarEstadoMediaUsuarios(usuarios, mediaID);
    }
