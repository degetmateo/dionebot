// import { ChatInputCommandInteraction, CacheType, User, ActionRowBuilder, ButtonBuilder, ButtonInteraction, EmbedBuilder } from "discord.js";
...
// export default class InteraccionComandoAfinidad extends CommandInteraction {
...
//         let usuariosRegistrados = this.bot.servers.getUsers(this.serverID);
...
//         try {
//             busquedaUsuario = await AnilistAPI.buscarUsuario(usuarioRegistrado.anilistId);   
//         } catch (error) {
//             if (error instanceof ErrorSinResultados) {
//                 throw new ErrorSinResultados(`No se ha encontrado al usuario  en anilist. Puede que su cuenta haya sido eliminada.`);
//             }
//             throw error;
//         }
